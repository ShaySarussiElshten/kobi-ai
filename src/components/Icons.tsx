...
export function HomeIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M5 9V16H8.5V12.5H11.5V16H15V9" />
    </svg>
  )
}
...
export function FlaskIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7.5 3H12.5" />
      <path d="M8.5 3V8L4 16H16L11.5 8V3" />
    </svg>
  )
}
...
export function ListOrderedIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 16 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
      ...
      <path d="M5 7H15" />
      <path d="M5 12H15" />
      <text x="0" y="4" fill="currentColor" stroke="none" fontSize="5" fontFamily="sans-serif" fontWeight="600">1</text>
      <text x="0" y="9" fill="currentColor" stroke="none" fontSize="5" fontFamily="sans-serif" fontWeight="600">2</text>
      <text x="0" y="14" fill="currentColor" stroke="none" fontSize="5" fontFamily="sans-serif" fontWeight="600">3</text>
    </svg>
  )
}
...
export function LinkIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9.5 6.5A3.5 3.5 0 0 0 6.5 5H5A3.5 3.5 0 0 0 5 12H6.5" />
    </svg>
  )
}
...
export function LinkChainIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8 12H10C12.21 12 14 10.21 14 8C14 5.79 12.21 4 10 4H8" />
      <path d="M5.5 8H10.5" />
    </svg>
  )
}
...
export function ExpandIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 3V13" />
      <path d="M4 6L8 3L12 6" />
      <path d="M4 10L8 13L12 10" />
    </svg>
  )
}
